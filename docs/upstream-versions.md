...
- Generated at: `2026-07-30 20:37:56` (UTC)
- Generated against git ref: `0b2a8e857eac92eab3bf40b80d4958bb4e92cb13`
...
| **openai** | `2.51.0` | version | (transitive in `.venv`) | [openai (PyPI)](https://pypi.org/project/openai/) |
...
| **python-discovery** | `1.5.0` | version | (transitive in `.venv`) | [python-discovery (PyPI)](https://pypi.org/project/python-discovery/) |
...
| **websockets** | `17.0` | version | (transitive in `.venv`) | [websockets (PyPI)](https://pypi.org/project/websockets/) |
