...
- Generated at: `2026-08-12 17:10:53` (UTC)
- Generated against git ref: `ebb1baa52545e92bb51e26cee2c1ff80f5c9fd91`
...
| Dependency | Current Pin | Pin Type | File Location | Upstream Repo |
|---|---|---|---|---|
| **agentgateway** | `v1.4.0` | tag | `config/templates/values/defaults.yaml` line 472 (`chartVersions.agentgateway`) | [agentgateway/agentgateway](https://github.com/agentgateway/agentgateway) (`oci://cr.agentgateway.dev/charts/`) |
...
| **lws** | `0.10.0` | tag | `config/templates/values/defaults.yaml` line 473 (`chartVersions.lws`) | [kubernetes-sigs/lws](https://github.com/kubernetes-sigs/lws) |
...
| **huggingface_hub** | `1.27.0` | version | `pyproject.toml` line 15 (direct) | [huggingface_hub (PyPI)](https://pypi.org/project/huggingface-hub/) |
...
| **platformdirs** | `4.11.2` | version | (transitive in `.venv`) | [platformdirs (PyPI)](https://pypi.org/project/platformdirs/) |
...
| **typing-inspection** | `0.4.3` | version | (transitive in `.venv`) | [typing-inspection (PyPI)](https://pypi.org/project/typing-inspection/) |
